...
export function VideoGenerator({ form, onComplete, onCancel }: Props) {
  ...
  }, [form.mainMedia, form.slideshowSecondsPerSlide, form.slideshowTransition, form.slideshowRandomOrder, form.videoAnimation, form.faceNodAnimation, form.convertToAnime, form.animeBackend, form.replicateApiKey, form.audioFile, form.audioTrimStart, form.audioTrimEnd, form.videoFile, form.title, form.artist, form.album, form.lyrics, form.includeLyrics, form.resolution, form.videoOrientation, form.preferGpu, form.durationSeconds, form.fps, form.style, form.visualizer, form.visualizerSize, form.visualizerPosition, form.backgroundEffect, form.imageOpacityWithEffect, form.frontImageOpacityWhenVideo, form.instrumental, form.cardStyle, form.cardAutoHide, form.cardAutoHideSeconds, form.loopMainVideoToAudio, form.convertMp4InputToWebm, form.exportMethod, form.renderEncoder, form.outputFormat, onComplete])
